<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExamMange.aspx.cs" Inherits="Exam_ExamMange" %>
    ...
    <div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:TextBox ID="hid1" runat="server" Text="题库选择" style="display:none"></asp:TextBox>
